...
<div class="pagination">
    <ul>
        ...
        <c:if test="${currentPage le noOfPages}">
            ...
            <c:if test="${sortBy.equals('master')}">
                <li>
                    <a href="${pageContext.request.contextPath}/controller?command=mainPageByMaster&page=${currentPage + 1}"><fmt:message key="next page"/></a>
                </li>
            </c:if>

            <c:if test="${sortBy.equals('service')}">
                <li>
                    <a href="${pageContext.request.contextPath}/controller?command=mainPageByService&page=${currentPage + 1}"><fmt:message key="next page"/></a>
                </li>
            </c:if>
